...
enum opt_code
{
  ...
  OPT_flto = 773,                            /* -flto */
  OPT_flto_compression_level_ = 774,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 775,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 776,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 777,              /* -flto-partition=max */
  OPT_flto_partition_none = 778,             /* -flto-partition=none */
  ...
  OPT_fomit_frame_pointer = 822,             /* -fomit-frame-pointer */
  OPT_fopenmp = 823,                         /* -fopenmp */
  OPT_fopenmp_simd = 824,                    /* -fopenmp-simd */
  OPT_foperator_names = 825,                 /* -foperator-names */
  OPT_fopt_info = 826,                       /* -fopt-info */
  OPT_fopt_info_ = 827,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 828, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 829,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 830,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 831,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 832, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 833, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 834, */      /* -force_flat_namespace */
  ...
  OPT_frtti = 903,                           /* -frtti */
  OPT_fsanitize_ = 904,                      /* -fsanitize= */
  OPT_fsaw_java_file = 905,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 906,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 907,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 908,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 909,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 910,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 911,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 912,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 913,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 914,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 915,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 916,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 917,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 918,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 919,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 920,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 921,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 922,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 923, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 924,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 925,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 926,              /* -fsecond-underscore */
  OPT_fsection_anchors = 927,                /* -fsection-anchors */
  /* OPT_fsee = 928, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 929,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 930,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 931, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 932,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 933,          /* -fselective-scheduling2 */
  OPT_fshort_double = 934,                   /* -fshort-double */
  OPT_fshort_enums = 935,                    /* -fshort-enums */
  OPT_fshort_wchar = 936,                    /* -fshort-wchar */
  OPT_fshow_column = 937,                    /* -fshow-column */
  OPT_fshrink_wrap = 938,                    /* -fshrink-wrap */
  OPT_fsign_zero = 939,                      /* -fsign-zero */
  OPT_fsignaling_nans = 940,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 941,               /* -fsigned-bitfields */
  OPT_fsigned_char = 942,                    /* -fsigned-char */
  OPT_fsigned_zeros = 943,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 944,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 945,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 946,               /* -fsource-filename= */
  OPT_fsource_ = 947,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 948,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 949,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 950,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 951, */                 /* -fsquangle */
  OPT_fstack_arrays = 952,                   /* -fstack-arrays */
  /* OPT_fstack_check = 953, */              /* -fstack-check */
  OPT_fstack_check_ = 954,                   /* -fstack-check= */
  OPT_fstack_limit = 955,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 956,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 957,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 958,                /* -fstack-protector */
  OPT_fstack_protector_all = 959,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 960,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 961,                   /* -fstack-reuse= */
  OPT_fstack_usage = 962,                    /* -fstack-usage */
  OPT_fstats = 963,                          /* -fstats */
  OPT_fstore_check = 964,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 965, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 966,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 967,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 968,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 969, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 970,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 971,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 972,                    /* -fsyntax-only */
  OPT_ftabstop_ = 973,                       /* -ftabstop= */
  /* OPT_ftarget_help = 974, */              /* -ftarget-help */
  OPT_ftarget_ = 975,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 976,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 977, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 978,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 979,             /* -fterminated-vtables */
  OPT_ftest_coverage = 980,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 981, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 982,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 983,             /* -fthreadsafe-statics */
  OPT_ftime_report = 984,                    /* -ftime-report */
  OPT_ftls_model_ = 985,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 986,               /* -ftoplevel-reorder */
  OPT_ftracer = 987,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 988,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 989,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 990,                  /* -ftrapping-math */
  OPT_ftrapv = 991,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 992,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 993,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 994,                       /* -ftree-ccp */
  OPT_ftree_ch = 995,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 996,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 997,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 998,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 999,                /* -ftree-copyrename */
  OPT_ftree_cselim = 1000,                   /* -ftree-cselim */
  OPT_ftree_dce = 1001,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1002,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1003,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1004,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1005,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1006, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1007,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1008,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1009,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1010,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1011,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1012, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1013,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1014,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1015,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1016,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1017,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1018,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1019,                      /* -ftree-pre */
  OPT_ftree_pta = 1020,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1021,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1022, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1023,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1024,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1025,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1026,                     /* -ftree-slsr */
  OPT_ftree_sra = 1027,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1028, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1029, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1030,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1031,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1032,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1033, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1034,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1035, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1036,                      /* -ftree-vrp */
  OPT_funderscoring = 1037,                  /* -funderscoring */
  OPT_funit_at_a_time = 1038,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1039,              /* -funroll-all-loops */
  OPT_funroll_loops = 1040,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1041,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1042,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1043,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1044,                 /* -funsigned-char */
  OPT_funswitch_loops = 1045,                /* -funswitch-loops */
  OPT_funwind_tables = 1046,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1047,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1048,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1049,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1050,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1051,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1052,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1053,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1054,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1055,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1056,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1057,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1058,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1059,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1060, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1061,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1062,                   /* -fverbose-asm */
  /* OPT_fversion = 1063, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1064,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1065,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1066,                   /* -fvisibility= */
  OPT_fvpt = 1067,                           /* -fvpt */
  /* OPT_fvtable_gc = 1068, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1069, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1070,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1071,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1072,                     /* -fvtv-debug */
  OPT_fweak = 1073,                          /* -fweak */
  OPT_fweb = 1074,                           /* -fweb */
  /* OPT_fwhole_file = 1075, */              /* -fwhole-file */
  OPT_fwhole_program = 1076,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1077,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1078,             /* -fworking-directory */
  OPT_fwpa = 1079,                           /* -fwpa */
  OPT_fwpa_ = 1080,                          /* -fwpa= */
  OPT_fwrapv = 1081,                         /* -fwrapv */
  /* OPT_fxref = 1082, */                    /* -fxref */
  /* OPT_fzee = 1083, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1084,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1085,                     /* -fzero-link */
  OPT_g = 1086,                              /* -g */
  OPT_gant = 1087,                           /* -gant */
  OPT_gcoff = 1088,                          /* -gcoff */
  OPT_gdwarf = 1089,                         /* -gdwarf */
  OPT_gdwarf_ = 1090,                        /* -gdwarf- */
  OPT_gen_decls = 1091,                      /* -gen-decls */
  OPT_gfull = 1092,                          /* -gfull */
  OPT_ggdb = 1093,                           /* -ggdb */
  OPT_ggnu_pubnames = 1094,                  /* -ggnu-pubnames */
  OPT_gnat = 1095,                           /* -gnat */
  OPT_gnatO = 1096,                          /* -gnatO */
  OPT_gno_pubnames = 1097,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1098,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1099,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1100,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1101,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1102,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1103,                   /* -gsplit-dwarf */
  OPT_gstabs = 1104,                         /* -gstabs */
  OPT_gstabs_ = 1105,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1106,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1107,                        /* -gtoggle */
  OPT_gused = 1108,                          /* -gused */
  OPT_gvms = 1109,                           /* -gvms */
  OPT_gxcoff = 1110,                         /* -gxcoff */
  OPT_gxcoff_ = 1111,                        /* -gxcoff+ */
  OPT_h = 1112,                              /* -h */
  OPT_headerpad_max_install_names = 1113,    /* -headerpad_max_install_names */
  OPT_idirafter = 1114,                      /* -idirafter */
  OPT_iframework = 1115,                     /* -iframework */
  OPT_imacros = 1116,                        /* -imacros */
  /* OPT_image_base = 1117, */               /* -image_base */
  OPT_imultiarch = 1118,                     /* -imultiarch */
  OPT_imultilib = 1119,                      /* -imultilib */
  OPT_include = 1120,                        /* -include */
  /* OPT_init = 1121, */                     /* -init */
  /* OPT_install_name = 1122, */             /* -install_name */
  OPT_iplugindir_ = 1123,                    /* -iplugindir= */
  OPT_iprefix = 1124,                        /* -iprefix */
  OPT_iquote = 1125,                         /* -iquote */
  OPT_isysroot = 1126,                       /* -isysroot */
  OPT_isystem = 1127,                        /* -isystem */
  OPT_iwithprefix = 1128,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1129,              /* -iwithprefixbefore */
  OPT_k8 = 1130,                             /* -k8 */
  OPT_keep_private_externs = 1131,           /* -keep_private_externs */
  OPT_l = 1132,                              /* -l */
  OPT_lang_asm = 1133,                       /* -lang-asm */
  OPT_m128bit_long_double = 1134,            /* -m128bit-long-double */
  OPT_m16 = 1135,                            /* -m16 */
  OPT_m32 = 1136,                            /* -m32 */
  OPT_m3dnow = 1137,                         /* -m3dnow */
  OPT_m3dnowa = 1138,                        /* -m3dnowa */
  OPT_m64 = 1139,                            /* -m64 */
  OPT_m80387 = 1140,                         /* -m80387 */
  OPT_m8bit_idiv = 1141,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1142,             /* -m96bit-long-double */
  OPT_mabi_ = 1143,                          /* -mabi= */
  OPT_mabm = 1144,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1145,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1146,                 /* -maddress-mode= */
  OPT_madx = 1147,                           /* -madx */
  OPT_maes = 1148,                           /* -maes */
  OPT_malign_double = 1149,                  /* -malign-double */
  OPT_malign_functions_ = 1150,              /* -malign-functions= */
  OPT_malign_jumps_ = 1151,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1152,                  /* -malign-loops= */
  OPT_malign_stringops = 1153,               /* -malign-stringops */
  OPT_march_ = 1154,                         /* -march= */
  OPT_masm_ = 1155,                          /* -masm= */
  OPT_matt_stubs = 1156,                     /* -matt-stubs */
  OPT_mavx = 1157,                           /* -mavx */
  OPT_mavx2 = 1158,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1159,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1160,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1161,                      /* -mavx512cd */
  OPT_mavx512er = 1162,                      /* -mavx512er */
  OPT_mavx512f = 1163,                       /* -mavx512f */
  OPT_mavx512pf = 1164,                      /* -mavx512pf */
  OPT_mbmi = 1165,                           /* -mbmi */
  OPT_mbmi2 = 1166,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1167,                  /* -mbranch-cost= */
  OPT_mcld = 1168,                           /* -mcld */
  OPT_mcmodel_ = 1169,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1170,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1171, */                    /* -mcpu= */
  OPT_mcrc32 = 1172,                         /* -mcrc32 */
  OPT_mcx16 = 1173,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1174,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1175,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 1176,                /* -mdynamic-no-pic */
  OPT_mf16c = 1177,                          /* -mf16c */
  OPT_mfancy_math_387 = 1178,                /* -mfancy-math-387 */
  OPT_mfentry = 1179,                        /* -mfentry */
  OPT_mfix_and_continue = 1180,              /* -mfix-and-continue */
  OPT_mfma = 1181,                           /* -mfma */
  OPT_mfma4 = 1182,                          /* -mfma4 */
  OPT_mforce_drap = 1183,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1184,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1185,                       /* -mfpmath= */
  OPT_mfsgsbase = 1186,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1187, */              /* -mfused-madd */
  OPT_mfxsr = 1188,                          /* -mfxsr */
  OPT_mhard_float = 1189,                    /* -mhard-float */
  OPT_mhle = 1190,                           /* -mhle */
  OPT_mieee_fp = 1191,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1192,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1193,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1194,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1195, */            /* -mintel-syntax */
  OPT_mkernel = 1196,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1197,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1198,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1199,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1200,                /* -mlong-double-80 */
  OPT_mlwp = 1201,                           /* -mlwp */
  OPT_mlzcnt = 1202,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1203,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1204,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1205,              /* -mmemset-strategy= */
  OPT_mmmx = 1206,                           /* -mmmx */
  OPT_mmovbe = 1207,                         /* -mmovbe */
  OPT_mms_bitfields = 1208,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1209,            /* -mno-align-stringops */
  OPT_mno_default = 1210,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1211,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1212,                  /* -mno-push-args */
  OPT_mno_red_zone = 1213,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1214,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1215,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1216,                 /* -mone-byte-bool */
  OPT_mpc32 = 1217,                          /* -mpc32 */
  OPT_mpc64 = 1218,                          /* -mpc64 */
  OPT_mpc80 = 1219,                          /* -mpc80 */
  OPT_mpclmul = 1220,                        /* -mpclmul */
  OPT_mpopcnt = 1221,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1222,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1223,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1224,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1225,                        /* -mprfchw */
  OPT_mpush_args = 1226,                     /* -mpush-args */
  OPT_mrdrnd = 1227,                         /* -mrdrnd */
  OPT_mrdseed = 1228,                        /* -mrdseed */
  OPT_mrecip = 1229,                         /* -mrecip */
  OPT_mrecip_ = 1230,                        /* -mrecip= */
  OPT_mred_zone = 1231,                      /* -mred-zone */
  OPT_mregparm_ = 1232,                      /* -mregparm= */
  OPT_mrtd = 1233,                           /* -mrtd */
  OPT_mrtm = 1234,                           /* -mrtm */
  OPT_msahf = 1235,                          /* -msahf */
  OPT_msha = 1236,                           /* -msha */
  OPT_msoft_float = 1237,                    /* -msoft-float */
  OPT_msse = 1238,                           /* -msse */
  OPT_msse2 = 1239,                          /* -msse2 */
  OPT_msse2avx = 1240,                       /* -msse2avx */
  OPT_msse3 = 1241,                          /* -msse3 */
  OPT_msse4 = 1242,                          /* -msse4 */
  OPT_msse4_1 = 1243,                        /* -msse4.1 */
  OPT_msse4_2 = 1244,                        /* -msse4.2 */
  OPT_msse4a = 1245,                         /* -msse4a */
  /* OPT_msse5 = 1246, */                    /* -msse5 */
  OPT_msseregparm = 1247,                    /* -msseregparm */
  OPT_mssse3 = 1248,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1249,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1250,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1251,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1252,            /* -mstringop-strategy= */
  OPT_mtbm = 1253,                           /* -mtbm */
  OPT_mtls_dialect_ = 1254,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1255,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1256,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1257,                         /* -mtune= */
  /* OPT_multi_module = 1258, */             /* -multi_module */
  /* OPT_multiply_defined = 1259, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1260, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1261,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1262,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1263,                    /* -mvzeroupper */
  OPT_mx32 = 1264,                           /* -mx32 */
  OPT_mxop = 1265,                           /* -mxop */
  OPT_mxsave = 1266,                         /* -mxsave */
  OPT_mxsaveopt = 1267,                      /* -mxsaveopt */
  OPT_n = 1268,                              /* -n */
  OPT_no_canonical_prefixes = 1269,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1270,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1271, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1272,                          /* -nocpp */
  OPT_nodefaultlibs = 1273,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1274,                /* -nofixprebinding */
  OPT_nomultidefs = 1275,                    /* -nomultidefs */
  OPT_noprebind = 1276,                      /* -noprebind */
  OPT_noseglinkedit = 1277,                  /* -noseglinkedit */
  OPT_nostartfiles = 1278,                   /* -nostartfiles */
  OPT_nostdinc = 1279,                       /* -nostdinc */
  OPT_nostdinc__ = 1280,                     /* -nostdinc++ */
  OPT_nostdlib = 1281,                       /* -nostdlib */
  OPT_o = 1282,                              /* -o */
  OPT_object = 1283,                         /* -object */
  OPT_p = 1284,                              /* -p */
  OPT_pagezero_size = 1285,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1286,                /* -pass-exit-codes */
  /* OPT_pedantic = 1287, */                 /* -pedantic */
  OPT_pedantic_errors = 1288,                /* -pedantic-errors */
  OPT_pg = 1289,                             /* -pg */
  OPT_pie = 1290,                            /* -pie */
  OPT_pipe = 1291,                           /* -pipe */
  OPT_prebind = 1292,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1293,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1294,                        /* -preload */
  OPT_print_file_name_ = 1295,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1296,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1297,          /* -print-multi-directory */
  OPT_print_multi_lib = 1298,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1299,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1300,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1301,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1302,               /* -print-prog-name= */
  OPT_print_search_dirs = 1303,              /* -print-search-dirs */
  OPT_print_sysroot = 1304,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1305,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1306,                 /* -private_bundle */
  OPT_pthread = 1307,                        /* -pthread */
  OPT_quiet = 1308,                          /* -quiet */
  OPT_r = 1309,                              /* -r */
  OPT_read_only_relocs = 1310,               /* -read_only_relocs */
  OPT_remap = 1311,                          /* -remap */
  OPT_s = 1312,                              /* -s */
  OPT_s_bc_abi = 1313,                       /* -s-bc-abi */
  OPT_save_temps = 1314,                     /* -save-temps */
  OPT_save_temps_ = 1315,                    /* -save-temps= */
  OPT_sectalign = 1316,                      /* -sectalign */
  OPT_sectcreate = 1317,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1318,              /* -sectobjectsymbols */
  OPT_sectorder = 1319,                      /* -sectorder */
  OPT_seg1addr = 1320,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1321, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1322, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1323, */                  /* -segaddr */
  OPT_segcreate = 1324,                      /* -segcreate */
  OPT_seglinkedit = 1325,                    /* -seglinkedit */
  OPT_segprot = 1326,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1327, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1328, */     /* -segs_read_write_addr */
  OPT_shared = 1329,                         /* -shared */
  OPT_shared_libgcc = 1330,                  /* -shared-libgcc */
  /* OPT_single_module = 1331, */            /* -single_module */
  /* OPT_specs = 1332, */                    /* -specs */
  OPT_specs_ = 1333,                         /* -specs= */
  OPT_static = 1334,                         /* -static */
  OPT_static_libasan = 1335,                 /* -static-libasan */
  OPT_static_libgcc = 1336,                  /* -static-libgcc */
  OPT_static_libgcj = 1337,                  /* -static-libgcj */
  OPT_static_libgfortran = 1338,             /* -static-libgfortran */
  OPT_static_libgo = 1339,                   /* -static-libgo */
  OPT_static_liblsan = 1340,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1341,               /* -static-libstdc++ */
  OPT_static_libtsan = 1342,                 /* -static-libtsan */
  OPT_static_libubsan = 1343,                /* -static-libubsan */
  /* OPT_std_c__03 = 1344, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1345, */                /* -std=c++0x */
  OPT_std_c__11 = 1346,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1347, */                /* -std=c++14 */
  OPT_std_c__1y = 1348,                      /* -std=c++1y */
  ...
  OPT_std_gnu__98 = 1366,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1367,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1368, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1369, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1370,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1371,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1372, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1373, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1374,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1375, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1376, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1377, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1378,                     /* -std=legacy */
  OPT_sub_library = 1379,                    /* -sub_library */
  OPT_sub_umbrella = 1380,                   /* -sub_umbrella */
  ...
  OPT_twolevel_namespace = 1388,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1389,       /* -twolevel_namespace_hints */
  OPT_u = 1390,                              /* -u */
  /* OPT_umbrella = 1391, */                 /* -umbrella */
  OPT_undef = 1392,                          /* -undef */
  OPT_undefined = 1393,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1394, */  /* -unexported_symbols_list */
  OPT_v = 1395,                              /* -v */
  OPT_version = 1396,                        /* -version */
  OPT_w = 1397,                              /* -w */
  /* OPT_weak_reference_mismatches = 1398, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1399,                    /* -whatsloaded */
  OPT_whyload = 1400,                        /* -whyload */
  OPT_wrapper = 1401,                        /* -wrapper */
  OPT_x = 1402,                              /* -x */
  OPT_y = 1403,                              /* -y */
  OPT_z = 1404,                              /* -z */
  N_OPTS,
